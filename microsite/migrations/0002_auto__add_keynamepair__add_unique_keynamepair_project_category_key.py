...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('microsite_keynamepair', (
            ...
            ('category', self.gf('django.db.models.fields.SlugField')(max_length=75)),
    ...
    models = {
        ...
        'microsite.keynamepair': {
            'Meta': {'unique_together': "(('project', 'category', 'key'),)", 'object_name': 'KeyNamePair'},
            'category': ('django.db.models.fields.SlugField', [], {'max_length': '75'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
